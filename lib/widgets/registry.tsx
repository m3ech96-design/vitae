...
export const WIDGET_REGISTRY: WidgetCatalogEntry[] = [
  // --- Task ---
  { id: "task-next", title: "Prossima task", category: "Task", defaultSize: "square", allowedSizes: ["square", "half"], Component: NextTaskWidget },
  { id: "task-today", title: "Task di oggi", category: "Task", defaultSize: "half", allowedSizes: ["half", "full"], Component: TodayTasksWidget },
  { id: "task-overdue", title: "Task scadute", category: "Task", defaultSize: "square", allowedSizes: ["square"], Component: OverdueTasksWidget },
  { id: "task-streak", title: "Streak task quotidiane", category: "Task", defaultSize: "square", allowedSizes: ["square"], Component: TaskStreakWidget },
  { id: "task-completed-week", title: "Completate questa settimana", category: "Task", defaultSize: "square", allowedSizes: ["square"], Component: CompletedThisWeekWidget },
  { id: "task-by-type", title: "Task per categoria", category: "Task", defaultSize: "half", allowedSizes: ["half", "full"], Component: TasksByTypeWidget },
  { id: "task-shopping-list", title: "Lista della spesa attiva", category: "Task", defaultSize: "half", allowedSizes: ["half", "full"], Component: ShoppingListWidget },
  { id: "task-recurring-today", title: "Ricorrenti non ancora fatte", category: "Task", defaultSize: "half", allowedSizes: ["half", "full"], Component: RecurringTodayWidget },
  { id: "task-quick-add", title: "Aggiungi task rapida", category: "Azioni rapide", defaultSize: "square", allowedSizes: ["square", "half"], Component: QuickAddTaskWidget },

  // --- Alimentazione ---
  { id: "food-calories-today", title: "Calorie di oggi", category: "Alimentazione", defaultSize: "square", allowedSizes: ["square"], Component: CaloriesTodayWidget },
  { id: "food-water-today", title: "Acqua bevuta", category: "Alimentazione", defaultSize: "square", allowedSizes: ["square"], Component: WaterTodayWidget },
  { id: "food-weekly-goal", title: "Obiettivo calorie settimanali", category: "Alimentazione", defaultSize: "square", allowedSizes: ["square", "half"], Component: WeeklyCaloriesGoalWidget },
  { id: "food-longest-fast", title: "Digiuno più lungo", category: "Alimentazione", defaultSize: "square", allowedSizes: ["square"], Component: LongestFastWidget },
  ...
  { id: "finance-last-expense", title: "Ultima spesa", category: "Finanze", defaultSize: "square", allowedSizes: ["square"], Component: LastExpenseWidget },
  { id: "finance-savings-total", title: "Risparmiato sugli obiettivi", category: "Finanze", defaultSize: "square", allowedSizes: ["square"], Component: SavingsGoalsTotalWidget },
  { id: "finance-cycle-leftover", title: "Rimasto nel ciclo", category: "Finanze", defaultSize: "square", allowedSizes: ["square"], Component: CycleLeftoverWidget },
  { id: "finance-next-planned", title: "Prossima spesa pianificata", category: "Finanze", defaultSize: "half", allowedSizes: ["half", "full"], Component: NextPlannedExpenseWidget },
  ...
  { id: "health-workout-streak", title: "Streak allenamenti", category: "Salute", defaultSize: "square", allowedSizes: ["square"], Component: WorkoutStreakWidget },
  { id: "health-weekly-minutes", title: "Minuti attivi (7gg)", category: "Salute", defaultSize: "square", allowedSizes: ["square"], Component: WeeklyActiveMinutesWidget },
  { id: "health-weight-chart", title: "Grafico peso (30gg)", category: "Salute", defaultSize: "half", allowedSizes: ["half", "full"], Component: WeightChart30dWidget },
  ...
  { id: "diary-streak", title: "Streak di scrittura", category: "Diario", defaultSize: "square", allowedSizes: ["square"], Component: DiaryStreakWidget },
  { id: "diary-one-year-ago", title: "Un anno fa oggi", category: "Diario", defaultSize: "half", allowedSizes: ["half", "full"], Component: OneYearAgoWidget },
  { id: "diary-quick-note", title: "Scrivi nota rapida", category: "Azioni rapide", defaultSize: "square", allowedSizes: ["square", "half"], Component: QuickDiaryNoteWidget },

  // --- Hobby ---
  { id: "hobby-next-activity", title: "Prossima attività da fare", category: "Hobby", defaultSize: "half", allowedSizes: ["half", "square"], Component: NextHobbyActivityWidget },
  { id: "hobby-last-metric", title: "Ultimo progresso metrica", category: "Hobby", defaultSize: "square", allowedSizes: ["square"], Component: LastMetricProgressWidget },
  { id: "hobby-last-match", title: "Ultima partita giocata", category: "Hobby", defaultSize: "square", allowedSizes: ["square"], Component: LastMatchWidget },
  { id: "hobby-collection-value", title: "Valore di una collezione", category: "Hobby", defaultSize: "square", allowedSizes: ["square"], Component: CollectionValueWidget },
  ...
  { id: "wishlist-saved-total", title: "Totale risparmiato", category: "Wishlist", defaultSize: "square", allowedSizes: ["square"], Component: WishlistSavedTotalWidget },
  { id: "wishlist-closest-goal", title: "Più vicino al completamento", category: "Wishlist", defaultSize: "half", allowedSizes: ["half", "square"], Component: ClosestToGoalWidget },
  { id: "wishlist-cheapest", title: "Più economico rimasto", category: "Wishlist", defaultSize: "square", allowedSizes: ["square"], Component: CheapestRemainingWidget },

  // --- Animali ---
  { id: "animali-next-meal", title: "Prossima pappa", category: "Animali", defaultSize: "square", allowedSizes: ["square"], Component: NextMealWidget },
  { id: "animali-next-vaccination", title: "Prossimo vaccino", category: "Animali", defaultSize: "square", allowedSizes: ["square", "half"], Component: NextVaccinationWidget },
  { id: "animali-weight-trend", title: "Peso animale — trend", category: "Animali", defaultSize: "square", allowedSizes: ["square"], Component: AnimalWeightTrendWidget },
  { id: "animali-days-since-adoption", title: "Giorni dall'adozione", category: "Animali", defaultSize: "square", allowedSizes: ["square"], Component: DaysSinceAdoptionWidget },
  { id: "animali-medications", title: "Farmaci in corso", category: "Animali", defaultSize: "half", allowedSizes: ["half", "full"], Component: AnimalMedicationsWidget },

  // --- Mappa / Luoghi ---
  { id: "map-most-visited", title: "Luogo più visitato del mese", category: "Mappa", defaultSize: "square", allowedSizes: ["square"], Component: MostVisitedPlaceWidget },
  { id: "map-last-visit", title: "Ultima visita registrata", category: "Mappa", defaultSize: "half", allowedSizes: ["half", "square"], Component: LastVisitWidget },
  { id: "map-favorite-spending", title: "Spesa nel luogo preferito", category: "Mappa", defaultSize: "square", allowedSizes: ["square"], Component: FavoritePlaceSpendingWidget },

  // --- Vitaecom ---
  { id: "vitaecom-unseen-stories", title: "Storie non viste", category: "Vitaecom", defaultSize: "square", allowedSizes: ["square"], Component: UnseenStoriesWidget },
  { id: "vitaecom-last-post", title: "Ultimo post pubblicato", category: "Vitaecom", defaultSize: "square", allowedSizes: ["square", "half"], Component: LastPostWidget },
  { id: "vitaecom-new-reactions", title: "Reazioni e commenti nuovi", category: "Vitaecom", defaultSize: "square", allowedSizes: ["square"], Component: NewReactionsWidget },
  { id: "vitaecom-last-message", title: "Ultimo messaggio ricevuto", category: "Vitaecom", defaultSize: "half", allowedSizes: ["half", "square"], Component: LastReceivedMessageWidget },
  ...
  // --- Rapporti ---
  { id: "rapporti-birthdays", title: "Compleanni in arrivo", category: "Rapporti", defaultSize: "half", allowedSizes: ["half", "full"], Component: UpcomingBirthdaysWidget },
  { id: "rapporti-today-birthday", title: "Compleanno di oggi", category: "Rapporti", defaultSize: "square", allowedSizes: ["square"], Component: TodayBirthdayWidget },
  ...
  { id: "news-today-digest", title: "Solo di oggi", category: "News", defaultSize: "full", allowedSizes: ["half", "full"], Component: TodayDigestWidget },

  // --- Trasversali ---
  { id: "cross-general-streak", title: "Streak generale", category: "Trasversali", defaultSize: "square", allowedSizes: ["square"], Component: GeneralStreakWidget },
  { id: "cross-profile-completion", title: "Percentuale profilo completato", category: "Trasversali", defaultSize: "square", allowedSizes: ["square"], Component: ProfileCompletionWidget },
  { id: "cross-active-goals", title: "Obiettivi attivi", category: "Trasversali", defaultSize: "square", allowedSizes: ["square", "half"], Component: ActiveGoalsWidget },
  { id: "cross-next-appointment", title: "Prossimo appuntamento (qualsiasi)", category: "Trasversali", defaultSize: "half", allowedSizes: ["half", "square"], Component: NextAnyAppointmentWidget },
