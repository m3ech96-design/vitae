import { VitaegramAccount, VitaegramPost } from "./vitaegram-social-types";
 ...
 */
export const DEMO_ACCOUNTS: VitaegramAccount[] = [
...
export function buildDemoPosts(): VitaegramPost[] {
  const now = Date.now();
  return [
    {
      id: "demo-post-1",
