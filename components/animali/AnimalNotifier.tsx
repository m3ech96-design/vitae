 ...
 *
 * Stesso scheletro esterno (guardia sul permesso + interval al minuto, vedi
 * lib/use-notification-polling.ts) degli altri tre notifier, ma qui aggrega 5 sotto-domini
 * con logiche di "è scattato?" diverse tra loro (pappa, vaccinazioni, farmaci, appuntamenti,
 * scorte) — non forzato nell'astrazione condivisa oltre lo scheletro esterno, la logica di
 * dominio resta qui perché è genuinamente specifica di ciascun sotto-caso.
 */
