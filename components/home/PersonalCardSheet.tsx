 ...
 * aver disegnato, e la mancata corrispondenza in fase di hydration può degenerare in
 * un'eccezione vera, non solo un avviso in console. Un `<div>` (di per sé un contenitore
 * altrettanto valido per il caso comune, un titolo-stringa) accetta invece legittimamente
 * qualunque figlio — risolto qui, per tutti i chiamanti presenti e futuri, non solo dove il
 * crash è stato notato.
 */
