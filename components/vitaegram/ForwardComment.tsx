...
import { VitaegramComment, VitaegramPost } from "@/lib/vitaegram-social-types";
...
function formatForward(comment: VitaegramComment, postAuthorNickname: string): string {
 ...
 * account Vitaegram invece no, perché senza una vera chat non c'è nessun posto dove quel
    ...
    <PersonalCardSheet title="Inoltra Commento" onClose={onClose}>
      ...
      >
        <span className="flex items-center gap-2">
          <Share2 size={15} /> Condividi Fuori Da Vitaegram
        </span>
      ...
      <p className="mb-2 mt-5 text-xs uppercase tracking-[0.1em] text-ink-800">Recenti Su Vitaegram</p>
