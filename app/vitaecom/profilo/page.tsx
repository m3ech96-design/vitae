...
function Bacheca() {
  ...
  const { hydrated, posts } = useVitaecomSocial();
  ...
  return (
    // Niente padding-top qui: "Home" si raggiunge già dalla barra "online" (vedi
    // OnlineNav), non c'era un secondo pulsante indietro sopra la Vetrina da spostare — il
    // problema era solo il padding fisso che la teneva staccata dal notch. La Vetrina
    // (dentro ProfileHeader, breakout a piena larghezza) porta ora il proprio
    // `pt-[max(env(safe-area-inset-top),...)]` e parte lei stessa da sotto il notch.
    <div className="mx-auto min-h-screen w-full max-w-xl pb-28">
