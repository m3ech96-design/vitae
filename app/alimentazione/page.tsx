...
import { ChevronLeft, ChevronRight, Plus, ListChecks, Package } from "lucide-react";
...
export default function AlimentazionePage() {
  ...
  return (
    <div className="mx-auto min-h-screen w-full max-w-xl px-5 pb-28 pt-[max(env(safe-area-inset-top),2.5rem)] sm:px-6">
      ...
      {/* Copia/incolla del menù è ora per singolo pasto — vedi il pulsante Copia/Incolla
         dentro ogni MealSlotSection, non più un'azione sull'intera giornata da qui. */}
